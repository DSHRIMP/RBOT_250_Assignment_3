...
: ${AMENT_CURRENT_PREFIX:="/home/prts/RBOT250/src/install/learning_tf2_cpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/learning_tf2_cpp/environment/pythonpath.sh"
